        ...
        <Navbar expand="md" className={"navbar-expand-sm fixed-top " + this.props.fighterCss}>
          <div className="container">
            ...
            {/* <div className="autocompleteContainer">
              ...
              <Autocomplete
                value={this.state.selectedFighter}
                inputProps={{ placeholder: 'COMPARE TO...', id: 'rivals-autocomplete' }}
                items={this.props.fighterNames}
                getItemValue={(item) => item.label}
                shouldItemRender={matchStateToTerm}
                onChange={(event, selectedFighter) => this.setState({ selectedFighter })}
                onSelect={selectedFighter => this.setState({ selectedFighter })}
