  ...
  return (
    <div className="home">
      ...
      <Jumbotron className="centered homeJumbotron">
        ...
        <Link to="/glossary" style={{ fontSize: '18px', fontFamily: 'Roboto, Helvetica, Sans-serif', webkittextstroke: '1px black', color: 'white', textShadow: '1px 1px 0 #000, -1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000,  1px 1px 0 #000' }}>Glossary</Link>
        <br />
        <Link to="/members" style={{ fontSize: '18px', fontFamily: 'Roboto, Helvetica, Sans-serif', webkittextstroke: '1px black', color: 'white', textShadow: '1px 1px 0 #000, -1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000,  1px 1px 0 #000' }}>Credits</Link>
      </Jumbotron>
      <Container className="mt-4 fighterList">
        <Row>
          {iconData.sort(function (a, b) {
            ...
            <Col xs={6} sm={3} md={3} lg={{ size: '3' }} xl={2} key={icon.name}>
              <FighterMenuItem
                key={icon.name}
